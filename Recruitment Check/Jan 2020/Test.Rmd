...
START_WEEK <- mdy("01/17/2020") #only change me, set as date of neuromap Startup meeting - 7 days
...
ENROLL_PASTWEEK_TITLE<- "Activity from Past Week (January 16th - January 23rd)" 
```
...
MASTER <- read_xlsx(paste0(directory_onedriveH, "NEUROMAP Master V2.xlsx"), sheet = "MasterData")
ENROLL_OVERVIEW <- read_xlsx(paste0(directory_onedriveH, "NEUROMAP Master V2.xlsx"), sheet = "RO1 Aggregate", col_names = TRUE)
...
SCHEDULE <-read_csv(paste0(directory_home, "Acuity Session Reports/schedule2020-01-24.csv")) #read in acuity schedule info
