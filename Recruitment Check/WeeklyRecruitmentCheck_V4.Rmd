...
MASTER<-loadWorkbook(system.file("NEUROMAP Master V2.xlsm", package = "XLConnect", password = "Hallquist351")) 

#read in data for master file spreadsheet and R01 information


MASTER <- read_xlsx("NEUROMAP Master V3 No Names.xlsm", sheet = "MasterData")
ENROLL_OVERVIEW <- read_xlsx("NEUROMAP Participant Tracker.xlsx", sheet = "RO1 Aggregate")
ENROLL_MASTER <- read_xlsx("NEUROMAP Participant Tracker.xlsx", sheet = "Master")
