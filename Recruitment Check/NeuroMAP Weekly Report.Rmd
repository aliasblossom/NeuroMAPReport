...
p_load("ggplot2", "dplyr", "tidyr", "cowplot", "qualtRics", "readxl", "tidyverse", "lubridate", "RColorBrewer", "kableExtra", "dygraphs", "xts")
...
neuroMAP_master<- ws_path %>% excel_sheets() %>%
  ...
  load_pdata(account = "strength", workbook = "Master")
...
Tracker <-load_pdata("strength", "Tracker")
...
```{r S3 Report Data Cleaning, include=FALSE}
