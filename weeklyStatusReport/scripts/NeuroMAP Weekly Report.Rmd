...
p_load("ggplot2", "dplyr", "tidyr", "cowplot", "qualtRics", "readxl", "tidyverse", "lubridate", "RColorBrewer", "kableExtra", "dygraphs", "xts", "ggtext", "DT", "showtext", "gganotate")
...
#THE FOLLOWING 2 LINES OF CODE ARE DEPRECIATED
...
print(datatable(s3_overview, container = sketch, rownames = FALSE))
...
```{r Source of Inquiry and Eligibility, echo=FALSE, warning=FALSE, fig.showtext=TRUE, out.width = "70%", fig.align = "center"}
